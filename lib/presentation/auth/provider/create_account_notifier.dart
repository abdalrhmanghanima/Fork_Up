...
class CreateAccountNotifier extends AsyncNotifier<RegisterEntity?>{
  ...
  Future<void> createAccount({required String phone,required String firstName,required String lastName})async{
    state = const AsyncLoading();
    state = await  AsyncValue.guard(()async{
      final useCase = ref.read(createAccountUseCaseProvider);
      return await useCase(phone: phone,firstName: firstName,lastName: lastName);
    });
  }
}
